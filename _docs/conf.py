...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.intersphinx', 'sphinx.ext.viewcode', 'sphinx.ext.phpdomain']
...
project = u'PHP Can'
copyright = unicode('2011-%s, %s' % (time.strftime('%Y'), "Dmitry Vinogradov <dmitri.vinogradov@gmail.com>"))
...
latex_documents = [
  ('index', 'Can.tex', u'PHP Can Documentation',
   "Dmitry Vinogradov", 'manual'),
]
